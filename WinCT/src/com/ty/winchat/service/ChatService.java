	...
	public void onCreate() {
	  ...
	  AudioInfo.Called= new Handler(){
			public void handleMessage(android.os.Message msg) {
				...
				Intent intent=new Intent(ChatService.this,AudioReceiver.class);
		...
		VideoInfo.Called= new Handler(){
			public void handleMessage(android.os.Message msg) {
				System.out.println("收到了视频聊天请求");
				Intent intent=new Intent(ChatService.this,VideoReceiver.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK); 
				startActivity(intent);
				super.handleMessage(msg);
			}
