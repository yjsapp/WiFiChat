...
import com.ty.winchat.ui.RoomChat.MyServiceConnection;
...
import com.xbc.Audio.CallOutActivity;
...
public class Main extends Base implements IconReceived{
	...
	private TCPFileListener fileListener;
	 final String[] chioce = {"发送即时消息", "开启语音会话", "开启视频会话"}; 
	 String IP="";
	 String LocalIp="";
...
//    	 SpotManager.getInstance(this).getSpotDialog();
    	...
    	listView.setOnChildClickListener(new OnChildClickListener() {
			...
			public boolean onChildClick(ExpandableListView parent, View v,
				...
				case 1:
					...
					IP=user.getIp();
					AudioInfo.ChatIp=IP;
					showSingleChoiceButton(childPosition);
    ...
    /**
     * 点击某个设备后进行的操作：选择要进行的操作
     */
    	private void showSingleChoiceButton(final int position){
  		AlertDialog.Builder builder = new AlertDialog.Builder(this);
  		builder.setTitle("请选择操作");
  		builder.setSingleChoiceItems(chioce, -1, new DialogInterface.OnClickListener(){
  		public void onClick(final DialogInterface dialog, int item) {
  	      	...
  	      	if(item==0){  //预留视频调度接口
    			   ...
    			   DisplayToast("开启语音会话");
    			   dialog.dismiss();
    			   UDPMessage message=WinChatApplication.mainInstance.getMyUdpMessage(MessageInfo.audio_call+"/"+AudioInfo.LocalIp, Listener.RECEIVE_MSG);
    				sendMsg(message);
    				Intent intent = new Intent();  
    				 intent.setClass(Main.this,CallOutActivity.class);  
    				 String type="audio";
    				 intent.putExtra("mediatype",type); 
    				 
    				 startActivity(intent);
    				 System.out.println("------"+"yuyinhujiao ");
    			   ...
    			   UDPMessage message=WinChatApplication.mainInstance.getMyUdpMessage(MessageInfo.video_call+"/"+AudioInfo.LocalIp, Listener.RECEIVE_MSG);
   				   sendMsg(message);
    			  	 
  			   Intent intent=new Intent(Main.this,CallOutActivity.class);
  			 String type="video";
			 intent.putExtra("mediatype",type); 
